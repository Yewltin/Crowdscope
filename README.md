...
* **All UI / UX Implemented**: Designed and implemented the UI and UX for the website as seen [here](#screenshots-of-homepage-map-ui), where accessibility was a key concern.
...
* **Styling framework / library** as referenced, styling was entirely by hand without the use of libraries etc. styling was kept minimal as I felt the heatmap and visual understanding of the user would be compromised in the scenario that the styling was distracting or would lead to visual overwhelm.
